...
var fs = __nccwpck_require__(895).require(),
...
exports.require = function() {
  ...
  if (process && process.versions && process.versions['electron']) {
	  try {
	    originalFs = __nccwpck_require__(941);
...
module.exports.FileSystem = __nccwpck_require__(895);
...
module.exports = (function() {
    ...
    var crcTable = [],
        Constants = __nccwpck_require__(522),
        Errors = __nccwpck_require__(255),
